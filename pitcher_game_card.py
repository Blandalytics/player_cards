...
def generate_chart(pitcher_id,game_id,game_df,game_group,szn_df,szn_comp,vs_past):
    ...
    fig.text(0.05,0.105,'Type',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.15,0.105,'#',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.25,0.105,'Velo',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.35,0.105,'IVB',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.4,0.105,'HB',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.5,0.105,'Str%',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.55,0.105,'SwStr%',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.65,0.105,'CSW%',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.75,0.105,'xSLGcon',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.85,0.105,'plvStuff+',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.95,0.105,'PLV+',color='w',fontsize=16,va='center',ha='center')

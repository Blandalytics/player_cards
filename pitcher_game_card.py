...
def generate_chart(pitcher_id,game_id,game_df,game_group,szn_df,szn_comp,vs_past):
    ...
    fig.text(0.1,0.24,'Type',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.23,0.24,'#',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.34,0.24,'Velo',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.42,0.24,'IVB',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.48,0.24,'HB',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.57,0.24,'Str%',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.645,0.24,'SwStr%',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.72,0.24,'CSW%',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.8,0.24,'xSLGcon',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.9,0.24,'plvStuff+',color='w',fontsize=16,va='center',ha='center')
    fig.text(0.955,0.24,'PLV+',color='w',fontsize=16,va='center',ha='center')
